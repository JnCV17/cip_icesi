...
@ManagedBean(name = "AlertDesasignacionController")
@SessionScoped
public class AlertDesasignacionController {
	...
	public AlertDesasignacionController() {
		descripcion = "descripcion correo";
	}

	public String getDescripcion() {
		ParamSmc mensaje = businessDelegate.findCycleActiveByProgram("AlertDesasignacion");
	...
	public void verificar() {
		...
		if (!descripcion.contains("{Subject}")) {
			...
			try {
				businessDelegate.updateAlertDesasignacion(descripcion);
