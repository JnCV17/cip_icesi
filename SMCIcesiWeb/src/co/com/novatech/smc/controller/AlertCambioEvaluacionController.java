...
@ManagedBean(name = "AlertCambioEvaluacionController")
@SessionScoped
public class AlertCambioEvaluacionController {
	...
	public AlertCambioEvaluacionController() {
		descripcion = "descripcion correo";
	}

	public String getDescripcion() {
		ParamSmc mensaje = businessDelegate.findCycleActiveByProgram("AlertCambioEstadoEvaluacion");
	...
	public void verificar() {
		...
		if (!descripcion.contains("{Subject}")) {
			...
			try {
				businessDelegate.updateAlertCambioEvaluacion(descripcion);
