...
@ManagedBean(name = "AlertEvaluacionController")
@SessionScoped
public class AlertEvaluacionController {
	...
	public AlertEvaluacionController() {
		descripcion = "descripcion correo";
	}

	public String getDescripcion() {
		ParamSmc mensaje = businessDelegate.findCycleActiveByProgram("AlertfechaEvaluacion");
	...
	public void verificar() {
		...
		if (!descripcion.contains("{Subject}")) {
			...
			try {
				businessDelegate.updateAlertFechaEvaluacion(descripcion);
